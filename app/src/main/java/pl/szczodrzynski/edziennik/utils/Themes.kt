...
object Themes {
    ...
    val themeList = arrayListOf(
            Theme(id = 0, name = R.string.theme_light, style = R.style.AppTheme_M2, isDark = false),
            Theme(id = 1, name = R.string.theme_dark, style = R.style.AppTheme_M3, isDark = false),
...
//            Theme(id = 17, name = R.string.theme_light_green, style = R.style.AppTheme_LightGreen, isDark = false)
    ...
    val appThemeNoDisplay: Int
        get() = if (theme.isDark) R.style.AppTheme_M3_NoDisplay else R.style.AppTheme_M2_NoDisplay
