...
class TemplateWebSample2(override val data: DataTemplate,
    ...
    init {
        webGet(TAG, "/api/v3/getData.php") {
            ...
            data.setSyncNext(ENDPOINT_TEMPLATE_WEB_SAMPLE_2, 2 * DAY, NavTarget.GRADES.id)
            // only if sync is executed on Home view
            data.setSyncNext(ENDPOINT_TEMPLATE_WEB_SAMPLE_2, syncIn = null, viewId = NavTarget.HOME.id)
